...
import AdvisoryPage from './pages/property/AdvisoryPage';
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/property/showroom" element={<PageTransition><PropertyHomePage /></PageTransition>} />
        ...
        <Route path="/property/advisory" element={<PageTransition><AdvisoryPage /></PageTransition>} />
