  ...
  return (
    <div className="min-h-screen bg-re-bg text-re-text pt-24">
      ...
      <div ref={heroRef} className="h-[60vh] relative flex items-center justify-center overflow-hidden">
        <motion.div 
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-black text-white opacity-[0.08] whitespace-nowrap pointer-events-none z-0 tracking-tighter"
