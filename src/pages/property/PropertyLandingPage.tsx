    ...
    <div className="flex-grow flex flex-col bg-[#0a0a0a] text-white pt-24">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden px-6">
        ...
        <div className="relative z-10 max-w-5xl text-center">
          ...
          >
            <Link 
              to="/property/showroom"
              className="px-12 py-5 bg-[#d4af37] text-black text-sm font-black uppercase tracking-widest hover:bg-white transition-colors flex items-center gap-4 group"
            >
              View Showroom
      ...
      <section className="py-24 px-6 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-12 max-w-7xl mx-auto w-full">
        <div className="space-y-4">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            We partner with world-class architects to bring you the most prestigious residential and commercial properties.
          </p>
        </div>
        <div className="space-y-4">
          <div className="w-12 h-12 bg-[#d4af37]/10 flex items-center justify-center text-[#d4af37] rounded-full">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            From the heart of Kampala to the most exclusive suburban enclaves, we secure the most sought-after addresses.
          </p>
        </div>
        <div className="space-y-4">
          <div className="w-12 h-12 bg-[#d4af37]/10 flex items-center justify-center text-[#d4af37] rounded-full">
          ...
          <h3 className="text-xl font-black uppercase tracking-tighter">Turnkey Solutions</h3>
          <p className="text-gray-400 text-sm leading-relaxed">
            Our comprehensive services cover everything from property acquisition and management to investment advisory.
          </p>
        </div>
      </section>
