      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden px-6">
        ...
        <div className="relative z-10 max-w-5xl text-center">
          ...
          >
            <Link 
              to="/cars/showroom"
              className="px-12 py-5 bg-black text-white text-sm font-black uppercase tracking-widest hover:bg-red-600 transition-colors flex items-center gap-4 group"
            >
              View Showroom
