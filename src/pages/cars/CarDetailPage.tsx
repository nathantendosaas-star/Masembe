  ...
  return (
    <div className="min-h-screen bg-auto-bg text-auto-text pt-24">
      ...
      <div ref={heroRef} className="h-[60vh] relative flex items-center justify-center overflow-hidden">
        <motion.div 
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-black text-auto-text opacity-[0.06] whitespace-nowrap pointer-events-none z-0 tracking-tighter"
          style={{ fontSize: 'clamp(80px, 12vw, 120px)', y: yText }}
        >
          {car.watermarkText}
        </motion.div>
