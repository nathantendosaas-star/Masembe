  ...
  return (
    <div className="p-8 pb-12">
      <div className="flex flex-col md:flex-row justify-between items-end mb-8 border-b border-gray-200 pb-8">
        <div>
          <h1 className="text-4xl font-black uppercase">{car.make}</h1>
          <h2 className="text-2xl text-gray-500 font-medium">{car.model}</h2>
        </div>
        <div className="text-right mt-6 md:mt-0">
          <p className="text-sm font-bold tracking-widest text-gray-400 uppercase">Starting Price</p>
          <p className="text-3xl font-mono font-bold text-red-600">{car.price}</p>
        </div>
      </div>
        ...
        {activeTab === 'overview' && (
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <p className="text-sm font-bold tracking-widest text-gray-400 uppercase">Year</p>
                <p className="text-2xl font-mono font-bold">{car.year}</p>
              </div>
              <div>
                <p className="text-sm font-bold tracking-widest text-gray-400 uppercase">Power</p>
            ...
            <div className="space-y-6">
              ...
              <div className="pt-6 border-t border-gray-200">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-mono text-2xl font-black text-red-600">Est. $340,900</span>
                </div>
            ...
            {submitSuccess ? (
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <input type="tel" name="phone" className="w-full bg-transparent border-b border-gray-600 pb-2 focus:outline-none focus:border-red-600 transition-colors" />
                </div>
                <div>
