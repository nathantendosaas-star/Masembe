    ...
    <div className={cn(
      ...
      <div className="h-[150vh]">
        ...
        >
          ...
          {/* Layer 1: The Parallax Watermark */}
          <AnimatePresence mode="wait">
            <WatermarkLayer key={`watermark-${activeItem.id}`} text={activeItem.watermark} theme={theme} />
          </AnimatePresence>
          ...
          <div className="relative z-20 w-full h-full flex items-center justify-center pointer-events-none">
            <AnimatePresence mode="popLayout">
              <motion.div
                ...
                className="w-[90vw] md:w-[60vw] max-w-5xl flex items-center justify-center pointer-events-auto cursor-pointer"
          ...
          {/* Layer 3: The Staggered Data Nodes */}
          <div className="absolute bottom-12 left-6 md:left-12 z-30 flex flex-col md:flex-row gap-6 md:gap-16 pointer-events-none">
            <AnimatePresence mode="wait">
              <motion.div 
